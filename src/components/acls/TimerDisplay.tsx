...
import { CprHandIcon } from '@/components/icons/ClinicalIcons';
...
export function CycleTimers({ 
  ...
  return (
    <div className={cn('grid gap-2', showEpiTimer ? 'grid-cols-2' : 'grid-cols-1')}>
      {/* CPR Cycle Timer */}
      <div
        className={cn(
...
export function CodeTimers({ totalElapsed, totalCPRTime }: CodeTimersProps) {
  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      {/* Total Code Time */}
      <div className="rounded-lg p-1.5 text-center bg-card border border-border">
      ...
      <div className="rounded-lg p-1.5 text-center bg-card border border-border">
        <div className="flex items-center justify-center gap-1 mb-0.5">
          <CprHandIcon className="h-3 w-3 text-muted-foreground" />
